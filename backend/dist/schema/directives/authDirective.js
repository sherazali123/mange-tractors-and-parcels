...
var disableAuthAccess = config_1.default.disableAuthAccess;
var AuthDirective = (function (_super) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (disableAuthAccess) {
                        return [2, resolve.apply(this, args)];
                    }
                    if (!context.auth) {
...
}(apollo_server_express_1.SchemaDirectiveVisitor));
